...
# PLUGINS
#
gcc -Wall -Wextra -g -std=c99 -O0 -march=native -ffast-math -funroll-loops -mfma -mavx2 -fPIC -shared -I./ -o cgi.so plugin_cgi/plugin_cgi.c
mv cgi.so ../plugins/cgi.so
...
gcc -Wall -Wextra -g -std=c99 -O0 -march=native -ffast-math -funroll-loops -mfma -mavx2 -fPIC -shared -I./ -o shape.so plugin_shape/plugin_shape.c plugin_shape/shape.c plugin_shape/plan.c -lm
